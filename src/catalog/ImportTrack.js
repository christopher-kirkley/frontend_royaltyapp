...
function ImportTrack () {
	...
	function handleUpload(e) {
		...
		e.preventDefault()
		fetch('http://localhost:5000/catalog/import-track', {
				method: 'POST',
				body: formData
			})
		.then(resp => resp.json())
	...
	return (
		<Container>
		<Typography variant="h6" color="textSecondary" align="center">Upload Track CSV</Typography>
			...
			>
				...
				<TextField id="track_to_upload" name="upload" type="file"/>	
				</Grid>
